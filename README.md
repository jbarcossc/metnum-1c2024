...
$$
C_{22} = A_{21} B_{12} + A_{22} B_{22} = \begin{pmatrix} 0 & 0 \\ 1 & 1 \end{pmatrix} + \begin{pmatrix} 0 & 5 \\ 0 & 2 \end{pmatrix} = \begin{pmatrix} 0 & 5 \\ 1 & 2 \end{pmatrix}
$$

$$
C_{22} \in \mathbb{R}^{2 \times 2}
$$
